...
public class VehicleController {
	...
	public static boolean create(final String chassis, final int year, final String color, final String plate, final Model model, final IClient client) {
	...
	public static DefaultTableModel getTableModel() {
		...
		for (int i = 0; i < vehicles.size(); i++) {
			...
			model.addRow(new Object[] {
				...
				curr.getYear(),
				curr.getColor(),
				curr.getPlate() != null ? curr.getPlate() : "",
				curr.getModel(),
				curr.getOwner()
			});
		}
